...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/css/main.css?<?=rand(100,10000)?>"/>
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse" id="pix-navbar-collapse">
									<ul class="nav navbar-nav navbar-right media-middle pix-header-nav pix-adjust-height" id="pix-header-nav">
										<li class="dropdown"><a href="/" class="pix-gray">ГЛАВНАЯ</a></li>
										<li class="dropdown"><a href="/faq/" class="pix-gray">ВОПРОСЫ/ОТВЕТЫ</a></li>
										<li class="dropdown"><a href="/news/" class="pix-gray">НОВОСТИ</a></li>
									</ul>
								</div>
							</div>
						</nav>
